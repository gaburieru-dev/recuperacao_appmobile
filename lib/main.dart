...
class _HomeState extends State<Home> {
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
            children: [
              ...
              _actionItem(icon: MdiIcons.cash, name: 'Transferir', isFirst: false),
              _actionItem(icon: MdiIcons.cash, name: 'Depositar', isFirst: false),
              _actionItem(icon: MdiIcons.creditCard, name: 'Recarga', isFirst: false),
              _actionItem(icon: MdiIcons.heartOutline, name: 'Doação', isFirst: false),
            ]
        ),
      ),
    );
  ...
  _actionItem({ required IconData icon, required String name, required bool isFirst }) {
    return Container(
